...
const (
	Processed                    Status = "processed"                        // Обработан
	Canceled                     Status = "canceled"                         // Отменён
	ProcessingFailed             Status = "processing_failed"                // Ошибка при обработке
	Created                      Status = "created"                          // Создан
	CleanedByUser                Status = "cleaned_by_user"                  // Очищен пользователем
	CleanedAutomaticallyAsTooOld Status = "cleaned_automatically_as_too_old" // Очищен автоматически
	AwaitingRetry                Status = "awaiting_retry"                   // Ожидает автоматического перезапуска
)
